...
public class Engine : MonoBehaviour {
	...
	public static int HeightRange, ChunkSpawnDistance, ChunkSideLength;
	public int lHeightRange, lChunkSpawnDistance, lChunkSideLength;
	...
	public static void SaveWorld () { // saves the data over multiple frames
		GameObject.FindWithTag("UBEngine").GetComponent<Engine>().StartCoroutine (ChunkDataFiles.SaveAllChunks());
	}
